...
| Ctrl+V в окошке виджета | Переводит то, что сейчас в буфере обмена |
...
| Esc или ✕ в шапке | Спрятать виджет — он останется в трее |
...
- **Показывать оригинал** — строчка с исходным текстом над переводом.
...
| `src/Translatorlight/WidgetForm.cs` | Само окошко: приём перетаскивания, показ перевода, перенос окна |
